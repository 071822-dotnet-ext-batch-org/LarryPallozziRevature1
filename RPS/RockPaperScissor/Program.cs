            ...
            while (true)
            {
                ...
                while (isTie)
                {
                             ...
                             (player1Choice == 3 && computerChoice == 2))
                    {
                        ...
                        // update the tally for this gaming session of how many games the computer and the user have won.
                        player1wins =
                            player1wins + 1; // this method gives you the option of incrementing by more than 1
                        // player1wins += 1;
                        // player1wins++;
                        isTie = false;
                    }
                ...
                Console.WriteLine($"Number of times {player1Name} won: {player1wins}");
                Console.WriteLine($"Number of times the computer won: {computerWins}");
                Console.WriteLine($"Number of tied games: {numberOfTies}\n");

                // Ask if they want to play again.(keep the tally live till the user wants to quit)
                Console.WriteLine("You really want to continue, right!? (Y)es (N)o\n");
                playAgain = Console.ReadLine();
                Console.WriteLine();
                ...
                {
                    Console.WriteLine("Too bad, let's play again sometime!\n");
                    break;
                }
